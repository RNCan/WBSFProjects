...
public:
    ...
    ~CGeoRef() {}
    CGeoRef& operator =(const CGeoRef& in)
    {
        m_prjID=in.m_prjID;
        return *this;
    }
    bool operator ==(const CGeoRef& in)const
    {
        return m_prjID==in.m_prjID;
    }
    bool operator !=(const CGeoRef& in)const
    {
        return !operator ==(in);
    ...
    {
        return m_prjID==PRJ_GEOGRAPHIC;
    }
    bool IsGeocentric()const
    {
        return m_prjID==PRJ_GEOCENTRIC;
    }
    bool IsProjected()const
    {
        return m_prjID==PRJ_PROJECTED;
    }
    ...
    friend std::ostream& operator<<(std::ostream &s, const CGeoRef& pt)
    {
        pt>>s;
        return s;
    }
    friend std::istream& operator>>(std::istream &s, CGeoRef& pt)
    {
        pt<<s;
        return s;
    }
...
public:
    ...
    CGeoPoint& operator =(const CGeoPoint& in)
    {
        CGeoRef::operator=(in);
        m_x = in.m_x;
        m_y = in.m_y;
    ...
    bool operator ==(const CGeoPoint& in)const
    {
        assert_PRJ((*this), in);
        return fabs(m_x-in.m_x)<EPSILON_COORDINATES && fabs(m_y-in.m_y)<EPSILON_COORDINATES;
    }
    bool operator !=(const CGeoPoint& in)const
    {
        return !operator ==(in);
    ...
    CGeoPoint operator -( ) const
    {
        return CGeoPoint(-m_x, -m_y, m_prjID);
    }
    CGeoPoint& operator *=(double v)
    {
        m_x*=v;
        m_y*=v;
        return *this;
    ...
    friend CGeoPoint operator *(double value, const CGeoPoint& point)
    {
        return CGeoPoint ( point.m_x*value, point.m_y*value, point.m_prjID );
    }
    friend CGeoPoint operator /(double value, const CGeoPoint& point)
    {
        return CGeoPoint ( point.m_x/value, point.m_y/value, point.m_prjID );
    ...
    friend CGeoPoint operator *(const CGeoPoint& point, double value )
    {
        return CGeoPoint ( point.m_x*value, point.m_y*value, point.m_prjID );
    }
    friend CGeoPoint operator /(const CGeoPoint& point, double value )
    ...
    static double GetDefaultArea(const CGeoPoint& pt1, const CGeoPoint& pt2)
    {
    ...
    friend std::ostream& operator<<(std::ostream &s, const CGeoPoint& pt)
    {
        pt>>s;
        return s;
    }
    friend std::istream& operator>>(std::istream &s, CGeoPoint& pt)
    {
        pt<<s;
        return s;
    }
...
inline CGeoPoint& CGeoPoint::operator += (const CGeoDistance& pt)
{
    assert_PRJ(*this, pt);
    m_x += pt.m_x;
    m_y += pt.m_y;
...
inline CGeoDistance operator -(const CGeoPoint& pt1, const CGeoPoint& pt2)
{
    assert_PRJ(pt1, pt2);
    return CGeoPoint(pt1.m_x - pt2.m_x, pt1.m_y - pt2.m_y, pt1.m_prjID);
}
inline CGeoPoint operator +(const CGeoPoint& pt1, const CGeoDistance& pt2)
{
    assert_PRJ(pt1, pt2);
    return CGeoPoint(pt1.m_x + pt2.m_x, pt1.m_y + pt2.m_y, pt1.m_prjID);
}
...
public:
    ...
    CGeoPoint3D& operator =(const CGeoPoint3D& in)
    {
        CGeoPoint::operator=(in);
        m_z = in.m_z;
        return *this;
    }
    bool operator ==(const CGeoPoint3D& in)const
    {
        assert_PRJ((*this), in);
        return CGeoPoint::operator==(in) && fabs(m_z - in.m_z)<EPSILON_COORDINATES;
    }
    bool operator !=(const CGeoPoint3D& in)const
    {
        return !operator ==(in);
    ...
    const double& operator () (size_t i)const
    {
        return (i < 2 ? CGeoPoint::operator()(i) : m_z);
    }
    double& operator () (size_t i)
    {
        return i <2 ? CGeoPoint::operator()(i) : m_z;
    }
    CGeoPoint3D operator -() const
    {
        return CGeoPoint3D(-m_x, -m_y, -m_z, m_prjID);
    }
    CGeoPoint3D& operator *=(double v)
    {
        m_x *= v;
        m_y *= v;
        m_z *= v;
    ...
    friend CGeoPoint3D operator *(double value, const CGeoPoint3D& point)
    {
        return CGeoPoint3D(point.m_x*value, point.m_y*value, point.m_z*value, point.m_prjID);
    }
    friend CGeoPoint3D operator /(double value, const CGeoPoint3D& point)
    {
        return CGeoPoint3D(point.m_x / value, point.m_y / value, point.m_z / value, point.m_prjID);
    ...
    friend CGeoPoint3D operator *(const CGeoPoint3D& point, double value)
    {
        return CGeoPoint3D(point.m_x*value, point.m_y*value, point.m_z*value, point.m_prjID);
    }
    friend CGeoPoint3D operator /(const CGeoPoint3D& point, double value)
    ...
    friend std::ostream& operator<<(std::ostream &s, const CGeoPoint3D& pt)
    {
        pt >> s;
        return s;
    }
    friend std::istream& operator>>(std::istream &s, CGeoPoint3D& pt)
    {
        pt << s;
        return s;
    }
...
inline CGeoPoint3D& CGeoPoint3D::operator += (const CGeoDistance3D& pt)
{
    assert_PRJ(*this, pt);
    m_x += pt.m_x;
    m_y += pt.m_y;
...
inline CGeoPoint3D operator + (const CGeoPoint3D& pt1, const CGeoDistance3D& pt2)
{
    assert_PRJ(pt1, pt2);
    return CGeoPoint3D(pt1.m_x + pt2.m_x, pt1.m_y + pt2.m_y, pt1.m_z + pt2.m_z, pt1.m_prjID);
}
inline CGeoDistance3D operator -(const CGeoPoint3D& pt1, const CGeoPoint3D& pt2)
{
    assert_PRJ(pt1, pt2);
    return CGeoDistance3D(pt1.m_x - pt2.m_x, pt1.m_y - pt2.m_y, pt1.m_z - pt2.m_z, pt1.m_prjID);
}
//*****************************************************************************************************
//CGeoSegment
...
public:
    ...
    CGeoSegment(const CGeoPoint& pt1, const CGeoPoint& pt2) :CGeoRef(pt1.GetPrjID())
    {
        assert_PRJ(pt1, pt2);
        m_pt1=pt1;
        m_pt2=pt2;
    ...
    //-------------------------------------------------
    double GetArea(const CGeoPoint& pt)const
    {
        return CGeoPoint::GetArea( m_pt1, m_pt2, pt);
    }
    ...
    //-------------------------------------------------
    bool IsSegmentNull()const
    {
        return m_pt1.m_x == 0 && m_pt1.m_y == 0 && m_pt2.m_x == 0 && m_pt2.m_y == 0;
    }
    bool IsSegmentEmpty()const
    {
        return m_pt1 == m_pt2;
    }
...
public:
    ...
    void clear()
    {
        m_xMin = m_xMax = m_yMin = m_yMax = -DBL_MAX;
    }
    void Reset()
    {
        clear();
    ...
    double Left()const
    {
        return std::min(m_xMax, m_xMin);
    }
    double Top()const
    {
        return std::max(m_yMax, m_yMin);
    }
    CGeoPoint UpperRight()const
    {
        return CGeoPoint(m_xMax, m_yMax, m_prjID);
    }
    CGeoPoint LowerLeft()const
    {
        return CGeoPoint(m_xMin,m_yMin, m_prjID);
    }
    CGeoPoint LowerRight()const
    {
        return CGeoPoint(m_xMax, m_yMin, m_prjID);
    }
    CGeoPoint UpperLeft()const
    {
        return CGeoPoint(m_xMin, m_yMax, m_prjID);
    }
    CGeoPoint UpperMidle()const
    {
        return CGeoPoint((m_xMin + m_xMax) / 2, m_yMax, m_prjID);
    }
    CGeoPoint LowerMidle()const
    {
        return CGeoPoint((m_xMin + m_xMax) / 2, m_yMin, m_prjID);
    }
    CGeoPoint CenterLeft()const
    {
        return CGeoPoint(m_xMin, (m_yMin + m_yMax) / 2, m_prjID);
    }
    CGeoPoint CenterRight()const
    {
        return CGeoPoint(m_xMax, (m_yMin + m_yMax) / 2,m_prjID);
    }
    CGeoPoint GetCentroid()const
    {
        return CGeoPoint((m_xMin + m_xMax) / 2, (m_yMin + m_yMax)/2, m_prjID);
    }
    ...
    static CGeoRect UnionRect(const CGeoRect& rect1, const CGeoRect& rect2)
    {
        return CGeoRect(rect1).UnionRect(rect2);
    }
    static CGeoRect IntersectRect(const CGeoRect& rect1, const CGeoRect& rect2)
    {
        return CGeoRect(rect1).IntersectRect(rect2);
    }
    ...
    char GetTestPosition(const CGeoPoint& pt)const
    {
        return GetTestPosition(pt.m_x, pt.m_y);
    }

    CGeoRect& operator -=(const CGeoPoint& point)
    {
        return OffsetRect( -point );
    }
    CGeoRect& operator +=(const CGeoPoint& point)
    {
        return OffsetRect( point );
    }
    CGeoRect& operator -=(double offset)
    {
    ...
    bool PtInRect(const CGeoPoint& pt)const
    {
        assert_PRJ((*this), pt);
        return pt.m_x>=m_xMin && pt.m_x<=m_xMax && pt.m_y>=m_yMin && pt.m_y<=m_yMax;
    }
    bool IsRectEmpty()const
    {
        return fabs( m_xMin-m_xMax) < EPSILON_COORDINATES || fabs(m_yMin-m_yMax) < EPSILON_COORDINATES;
    }
    bool IsEmpty()const
    {
        return IsRectEmpty();
    ...
    {
        return (m_xMin==0 && m_yMax==0 && m_xMax==0 && m_yMin==0);
    }
    bool IsNull() const
    {
        return IsRectNull();
    ...
    {
        assert_PRJ((*this), rect);
        return !(GetTestPosition(rect.LowerLeft()) & GetTestPosition(rect.UpperRight()));
    }
    bool IsIntersect(const CGeoRect& rect)const
    {
        return IsRectIntersect(rect);
    }
    ...
    std::ostream& operator>>(std::ostream &s)const
    {
        s << m_xMin << " " << m_xMax << " " << m_yMin << " " << m_yMax;
        return s;
    }
    std::istream& operator<<(std::istream &s)
    {
        s >> m_xMin >> m_xMax >> m_yMin >> m_yMax;    /*>>((CGeoRef&)*this)*/
        return s;
    }
    friend std::ostream& operator<<(std::ostream &s, const CGeoRect& rect)
    {
        rect>>s;
        return s;
    }
    friend std::istream& operator>>(std::istream &s, CGeoRect& rect)
    {
        rect<<s;
        return s;
    }
...
public:
    ...
    CGeoRect3D(const CGeoRect3D& in)
    {
        operator =(in);
    }
    ...
    CGeoPoint3D GetCentroid()const
    {
        return CGeoPoint3D((m_xMin + m_xMax) / 2, (m_yMin + m_yMax) / 2, (m_zMin + m_zMax) / 2, m_prjID);
    }
    ...
    static CGeoRect3D UnionRect(const CGeoRect3D& rect1, const CGeoRect3D& rect2)
    {
        return CGeoRect3D(rect1).UnionRect(rect2);
    }
    static CGeoRect3D IntersectRect(const CGeoRect3D& rect1, const CGeoRect3D& rect2)
    {
        return CGeoRect3D(rect1).IntersectRect(rect2);
    }
    ...
    char GetTestPosition(const CGeoPoint3D& pt)const
    {
        return GetTestPosition(pt.m_x, pt.m_y, pt.m_z);
    }

    CGeoRect3D& operator -=(const CGeoPoint3D& point)
    {
        return OffsetRect(-point);
    }
    CGeoRect3D& operator +=(const CGeoPoint3D& point)
    ...
    CGeoRect3D& operator -=(double offset)
    {
        return operator+=(-offset);
    }
    CGeoRect3D& operator +=(double offset)
...
//CGeoRect3D& InflateRect(double w, double n, double e, double s);
    ...
    bool IsEmpty()const
    {
        return CGeoRect::IsEmpty() && ( fabs(m_zMin - m_zMax) < EPSILON_COORDINATES );
    }
    bool IsNormal()const
    {
        return CGeoRect::IsNormal() && (m_zMin <= m_zMax);
    }
    bool IsNull() const
    {
        return CGeoRect::IsNull()&& (m_zMin == 0 && m_zMax == 0);
    }
    ...
    friend std::ostream& operator<<(std::ostream &s, const CGeoRect3D& rect)
    {
        rect >> s;
        return s;
    }
    friend std::istream& operator>>(std::istream &s, CGeoRect3D& rect)
    {
        rect << s;
        return s;
    }
...
//*****************************************************************************************************
//CGeoVector
typedef std::deque<CGeoPoint> CGeoPointVector;
typedef std::deque<CGeoRect> CGeoRectVector;
...
public:
    ...
    bool operator ==(const CGeoPointIndex& in)const
    {
    ...
    CGeoPointIndex operator -( ) const
    {
        return CGeoPointIndex(-m_x, -m_y);
    }
    CGeoPointIndex& operator *=(double in)
    {
        m_x = int(m_x*in);
        m_y = int(m_y *in);
        return *this;
    ...
    CGeoPointIndex& operator +=(int in)
    {
        m_x += in;
        m_y += in;
        return *this;
    ...
    bool operator >(const CGeoPointIndex& in)
    {
        return m_x > in.m_x  && m_y>in.m_y;
    }
    bool operator >=(const CGeoPointIndex& in)
    ...
    friend CGeoPointIndex operator *(int value, const CGeoPointIndex& point)
    {
        return CGeoPointIndex ( point.m_x*value, point.m_y*value );
    }
    friend CGeoPointIndex operator /(int value, const CGeoPointIndex& point)
    {
        return CGeoPointIndex ( point.m_x/value, point.m_y/value );
    ...
    friend CGeoPointIndex operator *(const CGeoPointIndex& point, int value )
    {
        return CGeoPointIndex ( point.m_x*value, point.m_y*value );
    }
    friend CGeoPointIndex operator /(const CGeoPointIndex& point, int value )
    ...
    friend std::ostream& operator<<(std::ostream &s, const CGeoPointIndex& pt)
    {
        pt>>s;
        return s;
    }
    friend std::istream& operator>>(std::istream &s, CGeoPointIndex& pt)
    {
        pt<<s;
        return s;
    }
...
inline CGeoSize CGeoPointIndex::GetDistance(const CGeoPointIndex& pt)const
{
    return CGeoSize(abs(pt.m_x - m_x), abs(pt.m_y - m_y));
}
inline CGeoPointIndex& CGeoPointIndex::operator +=(const CGeoSize& in)
{
    m_x += in.m_x;
    m_y += in.m_y;
    return *this;
...
inline CGeoSize GetDistance(const CGeoPointIndex& pt1, const CGeoPointIndex& pt2)
{
    return pt1.GetDistance(pt2);
}
inline CGeoSize operator -(const CGeoPointIndex& pt1, const CGeoPointIndex& pt2)
{
    return pt1.GetDistance(pt2);
}
inline CGeoPointIndex operator +(const CGeoPointIndex& pt1, const CGeoSize& pt2)
{
    return CGeoPointIndex(pt1.m_x + pt2.m_x, pt1.m_y + pt2.m_y);
}
inline CGeoPointIndex operator /(const CGeoPointIndex& point, const CGeoSize& size)
{
    return CGeoPointIndex(int(point.m_x / size.m_x), int(point.m_y / size.m_y));
}
//*****************************************************************************************************
//CGeoPoint3DIndex
class CGeoSize3D;
...
public:
    ...
    void clear()
    {
        CGeoPointIndex::clear();
        m_z = -1;
    }
    bool operator ==(const CGeoPoint3DIndex& in)const
    {
        return CGeoPointIndex::operator==(in) && m_z == in.m_z;
    }
    bool operator !=(const CGeoPoint3DIndex& in)const
    {
        return !operator==(in);
    ...
    CGeoPoint3DIndex operator -() const
    {
        return CGeoPoint3DIndex(-m_x, -m_y, -m_z);
    }
    CGeoPoint3DIndex& operator *=(int in)
    {
        m_x *= in;
        m_y *= in;
        m_z *= in;
    ...
    bool operator >(const CGeoPoint3DIndex& in)
    {
    ...
    friend CGeoPoint3DIndex operator *(int value, const CGeoPoint3DIndex& point)
    {
        return CGeoPoint3DIndex(point.m_x*value, point.m_y*value, point.m_z*value);
    }
    friend CGeoPoint3DIndex operator /(int value, const CGeoPoint3DIndex& point)
    {
        return CGeoPoint3DIndex(point.m_x / value, point.m_y / value, point.m_z/value);
    ...
    friend CGeoPoint3DIndex operator *(const CGeoPoint3DIndex& point, int value)
    {
        return CGeoPoint3DIndex(point.m_x*value, point.m_y*value, point.m_z*value);
    }
    friend CGeoPoint3DIndex operator /(const CGeoPoint3DIndex& point, int value)
    ...
    friend std::ostream& operator<<(std::ostream &s, const CGeoPoint3DIndex& pt)
    {
        pt >> s;
        return s;
    }
    friend std::istream& operator>>(std::istream &s, CGeoPoint3DIndex& pt)
    {
        pt << s;
        return s;
    }
...
CGeoSize3D CGeoPoint3DIndex::GetDistance(const CGeoPoint3DIndex& pt)const
{
    return CGeoSize3D(abs(pt.m_x - m_x), abs(pt.m_y - m_y), abs(pt.m_z - m_z));
}
inline CGeoSize3D GetDistance(const CGeoPoint3DIndex& pt1, const CGeoPoint3DIndex& pt2)
{
    return pt1.GetDistance(pt2);
}
inline CGeoSize3D operator -(const CGeoPoint3DIndex& pt1, const CGeoPoint3DIndex& pt2)
{
    return CGeoSize3D(pt1.m_x - pt2.m_x, pt1.m_y - pt2.m_y, pt1.m_z - pt2.m_z);
}
inline CGeoPoint3DIndex operator +(const CGeoPoint3DIndex& pt1, const CGeoSize3D& pt2)
{
    return CGeoPoint3DIndex(pt1.m_x + pt2.m_x, pt1.m_y + pt2.m_y, pt1.m_z + pt2.m_z);
}
inline CGeoPoint3DIndex operator /(const CGeoPoint3DIndex& point, const CGeoSize3D& size)
{
    return CGeoPoint3DIndex(int(point.m_x / size.m_x), int(point.m_y / size.m_y), int(point.m_z / size.m_z));
}
...
public:
    ...
    {
        return CGeoSize(m_xSize, m_ySize);
    }

    CGeoPointIndex UpperRight()const
    {
        return CGeoPointIndex(m_x + std::max(m_xSize - 1, 0), m_y);
    }
    CGeoPointIndex LowerLeft()const
    {
        return CGeoPointIndex(m_x, m_y + std::max(m_ySize - 1, 0));
    }
    CGeoPointIndex LowerRight()const
    {
        return CGeoPointIndex(m_x + std::max(m_xSize - 1, 0), m_y + std::max(m_ySize - 1, 0));
    }
    CGeoPointIndex UpperLeft()const
    {
        return CGeoPointIndex(m_x, m_y);
    }
    ...
    static CGeoRectIndex UnionRect(const CGeoRectIndex& rect1, const CGeoRectIndex& rect2)
    {
        return CGeoRectIndex(rect1).UnionRect(rect2);
    }
    static CGeoRectIndex IntersectRect(const CGeoRectIndex& rect1, const CGeoRectIndex& rect2)
    {
        return CGeoRectIndex(rect1).IntersectRect(rect2);
    }

    //void Inflate(float percent);
    void InflateRect( int w, int n, int e, int s );
    void DeflateRect(int w, int n, int e, int s)
    {
        InflateRect(-w,-n,-e,-s);
    }
    ...
    bool PtInRect(const CGeoPointIndex& pt)const
    {
        return PtInRect(pt.m_x, pt.m_y);
    }
    ...
    friend std::ostream& operator<<(std::ostream &s, const CGeoRectIndex& rect)
    {
        rect>>s;
        return s;
    }
    friend std::istream& operator>>(std::istream &s, CGeoRectIndex& rect)
    {
        rect<<s;
        return s;
    }
...
public:
    ...
    CGeoExtents(const CGeoExtents& in)
    {
        operator=(in);
    }
    void clear()
    ...
    double XRes()const
    {
        return m_xSize>0?(m_xMax - m_xMin)/m_xSize:0;
    }
    ...
    double YRes()const
    {
        return m_ySize>0?(m_yMin - m_yMax)/m_ySize:0;
    }
    ...
    bool IsEmpty()const
    {
        return m_xSize==0 || m_ySize==0 || CGeoRect::IsEmpty();
    }
    ...
    CGeoRectIndex GetPosRect()const
    {
        return CGeoRectIndex(0,0,m_xSize, m_ySize);
    }
    ...
    int XNbBlocks()const
    {
        return (int)ceil( (double)m_xSize/m_xBlockSize );
    }
    int YNbBlocks()const
    {
        return (int)ceil( (double)m_ySize/m_yBlockSize );
    }
    int GetNbBlocks()const
    {
        return XNbBlocks()*YNbBlocks();
    }
    void SetNbBlocks(int xNbBlocks, int yNbBlocks)
    {
        m_xBlockSize=(int)ceil( (double)m_xSize/xNbBlocks );
        m_yBlockSize=(int)ceil( (double)m_ySize/yNbBlocks );
    }
    ...
    CGeoExtents GetBlockExtents(CGeoBlockIndex ij)const
    {
        return GetBlockExtents(ij.m_x, ij.m_y);
    }
    ...
    CGeoRectIndex GetBlockRect(CGeoBlockIndex ij)const
    {
        return GetBlockRect(ij.m_x, ij.m_y);
    }
    ...
    void SetBlockSize( CGeoSize size )
    {
        m_xBlockSize=size.m_x;
        m_yBlockSize=size.m_y;
    }
    ...
    std::ostream& operator>>(std::ostream &s)const
    {
        s << ((CGeoRect&)*this) << " " << m_xSize << " " << m_ySize << " " << m_xBlockSize  << " " << m_yBlockSize;
        return s;
    }
    std::istream& operator<<(std::istream &s)
    {
    ...
    friend std::ostream& operator<<(std::ostream &s, const CGeoExtents& extents)
    {
        extents>>s;
        return s;
    }
    friend std::istream& operator>>(std::istream &s, CGeoExtents& extents)
    {
        extents<<s;
        return s;
    }
...
public:
    ...
    std::ostream& operator>>(std::ostream &s)const
    {
        s << ((CGeoPoint3D&)*this) << " " << m_latitudeDeg << " " << m_slope << " " << m_aspect << " " << m_shore << " " << m_event;
        return s;
    }
    std::istream& operator<<(std::istream &s)
    {
    ...
    friend std::ostream& operator<<(std::ostream &s, const CGridPoint& in)
    {
        in>>s;
        return s;
    }
    friend std::istream& operator>>(std::istream &s, CGridPoint& out)
    {
        out<<s;
        return s;
    }
...
class CGridPointVector : public std::vector<CGridPoint>
{
public:
    ...
    std::ostream& operator>>(std::ostream &s)const;
    std::istream& operator<<(std::istream &s);
    friend std::ostream& operator<<(std::ostream &s, const CGridPointVector& in)
    {
        in >> s;
        return s;
    }
    friend std::istream& operator>>(std::istream &s, CGridPointVector& out)
    {
        out << s;
        return s;
    }
...
inline void CGeoPoint::SetXY(const CGeoPoint3D& pt)
{
    SetXY(pt.m_x, pt.m_y, pt.m_z);
}
...
//    double y = 360.0;
    ...
    return CGeoPoint3D(6371 * 1000 * cos(xx)*sin(yy), 6371 * 1000 * sin(xx)*sin(yy), 6371 * 1000 * cos(yy), PRJ_GEOCENTRIC);
}
