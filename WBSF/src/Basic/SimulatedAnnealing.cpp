...
std::string CSAControl::GetMember(size_t i)const
{
    ...
    switch (i)
    {
    case TYPE_OPTIMISATION:
        str = to_string(m_bMax);
        break;
    case STAT_OPTIMISATION:
        str = to_string(m_statisticType);
        break;
    ...
    case NB_CYCLE:
        ...
        break;
    case NB_SKIP_LOOP:
        str = to_string(m_nbSkipLoop);
        break;
    case NB_ITERATION:
        str = to_string(m_NT);
        break;
    case NB_EPSILON:
        str = to_string(m_NEPS);
        break;
    case MAX_EVALUATION:
        str = to_string(m_MAXEVL);
        break;
    case SEED1:
        str = to_string(m_seed1);
        break;
    case SEED2:
        str = to_string(m_seed2);
        break;
