...
public:
    ...
    {
        if (m_type != kMVLine) m_caption = caption;
    }
    ...
    int GetEndFirstField()const
    {
        return m_beginSecondField - MARGIN_HORZ;
    }
    int GetBeginSecondField()const
    {
        return m_beginSecondField;
    }
    void SetBeginSecondField(int val)
    {
        m_beginSecondField = val;
    }

    ///***********************///*********************///*****************
    bool IsAVariable()const
    {
        return m_type != kMVTitle && m_type != kMVLine && m_type != kMVStaticText;
    }
    ...
    {
        return GetTypeName(short(m_type));
    }

    std::vector<std::string> GetList(const std::string& appPath = "", const std::string& projectPath = "")const;
