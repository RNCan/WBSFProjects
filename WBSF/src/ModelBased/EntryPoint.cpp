...
extern "C"
{
    ...
    bool RunModel(IAgent* agent, uint32_t hxGridSessionId, istream& inStream, ostream& outStream)
    {
        ERMsg msg;
...
//ERMsg BeginSession(IAgent* agent, int32_t sessionId, int32_t hxGridSessionId, IGenericStream* globalDataStream = NULL)
//{
//    ERMsg msg;
...
//   DllExport  bool __cdecl InitSimulatedAnnealing(int32_t sessionId, IGenericStream* pStream, char* errorMessage)
//   {
