...
int CDailyDatabase::GetVersion(const std::string& filePath)
{
    return CDHDatabaseBase::GetVersion(filePath);
}
ERMsg CDailyDatabase::DeleteDatabase(const std::string&  outputFilePath, CCallback& callback)
{
    return CDHDatabaseBase::DeleteDatabase(outputFilePath, callback);
}
ERMsg CDailyDatabase::RenameDatabase(const std::string& inputFilePath, const std::string& outputFilePath, CCallback& callback)
{
