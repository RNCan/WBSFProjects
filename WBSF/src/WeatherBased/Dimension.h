...
public:
    ...
    static const char * GetDimensionName(size_t d)
    {
        assert(d < NB_DIMENSION);
        return DIMENSION_NAME[d];
    }
...
protected:
    ...
    //static std::vector<std::string> DIMENSION_TITLE;
