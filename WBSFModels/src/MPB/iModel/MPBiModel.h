...
namespace WBSF
{
	...
	enum TDaily{ D_EGG, D_L1, D_L2, D_L3, D_L4, D_PUPA, D_TENERAL_ADULT, D_OVIPOSITING_ADULT, D_DEAD_ADULT, D_BROOD, D_NB_ATTACKS, D_NB_SUCESS_ATTACKS, D_INFESTED_KM2, D_INFESTED_KM2_CUMUL, D_DEAD_BY_TREE, D_DEAD_DENSITY_DEPENDENCE, D_DEAD_ATTRITION, D_EGG_DEAD_FROZEN, D_LARVAL_DEAD_FROZEN, D_PUPA_DEAD_FROZEN, D_TENERAL_DEAD_FROZEN, D_OVIPADULT_DEAD_FROZEN, D_BIVOLTIN, D_UNIVOLTIN, D_SEMIVOLTIN, D_TRIENVOLTIN, D_NB_OBJECTS, D_NB_PACK, D_DD_FACTOR, NB_DAILY_OUTPUT };
	enum TAnnual { A_ATTACK, A_SUCCESS_ATTACK, A_R, A_EGG, A_LARVAL, A_PUPA, A_TENERAL, A_OVIPADULT, A_EGG_CREATED, A_BROOD, A_FECONDITY, A_DEAD_FROZEN, A_DEAD_OLD_AGE, A_DEAD_BY_TREE, A_DEAD_DENSITY_DEPENDENCE, A_DEAD_ATTRITION, A_INFESTED_KM2, A_INFESTED_KM2_CUMUL, A_EGG_DEAD_FROZEN, A_LARVAL_DEAD_FROZEN, A_PUPA_DEAD_FROZEN, A_TENERAL_DEAD_FROZEN, A_OVIPADULT_DEAD_FROZEN, A_BIVOLTIN, A_UNIVOLTIN, A_SEMIVOLTIN, A_TRIENVOLTIN, A_NB_OBJECT_ALIVE, A_NB_PACK, A_DD_FACTOR, A_LONGIVITY, A_YEAR, A_MONTH, A_DAY, A_YEAR_END, A_MONTH_END, A_DAY_END/*, A_MONTH_PEAK, A_DAY_PEAK*/, NB_ANNUAL_OUTPUT };
