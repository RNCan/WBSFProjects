...
namespace WBSF
{
	...
	const double CSpruceBudwormEquations::P[NB_EQUATION][NB_PARAMETER] =
	{
		...
		0.362, 2.910, 5.320, 0.061, 4.4, 38, //Feeding L2
		0.461, 3.060, 6.850, 0.061, 4.4, 38, //L3
		0.708, 3.800, 7.550, 0.148, 4.4, 38, //L4
		0.332, 3.020, 8.570, 0.005, 4.4, 38, //L5
		0.351, 2.670, 5.030, 0.151, 4.4, 38, //L6 male
		0.386, 3.060, 4.660, 0.136, 4.4, 38, //L6 female
	...
	double CSpruceBudwormEquations::get_L(double A)
	{
		return sqrt(A / 0.325);
	}
